...
class User(AbstractBaseUser):
    ...
    role = models.PositiveSmallIntegerField(choices=ROLE_CHOICE, blank=True, null=True, verbose_name="User Role") #null=True handles any errors
    ...
    is_superuser = models.BooleanField(default=False)  # Built-in
    is_superadmin = models.BooleanField(default=False)  # custom
...
class UserProfile(models.Model):
    user = models.OneToOneField(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, blank=True, null=True) # one to one allows only single user profile
